...
flowchart LR
    ...
    %% ===== AM — v216 Question-tool instruction server-push override (#168 HIGH — static; not yet wire-confirmed) =====
    subgraph CHOICEINJ["AM — Question-Tool Instruction Server-Push Override (v2.1.216 #168 HIGH — empty-default string reaches model context; not yet wire-confirmed)"]
        direction TB
        ...
        qi_sink["Built-in multiple-choice question tool<br/>instruction text → /v1/messages verbatim<br/>#106 / #154 / #165 family; distinct flag + sink-role<br/>HIGH: reach derived from the call site,<br/>not yet wire-confirmed (natural escalation)"]:::gap
        qi_flag --> qi_validate
