...
**Date**: 2026-04-10 · **Last revised**: 2026-07-20 (session 80, v2.1.215 currency pass)
**Version**: 1.7
...
*Investigation conducted 2026-04-10; revised 2026-07-20 (session 80). Binary analysis on v2.1.96, v2.1.97, v2.1.98, v2.1.100; currency re-verified against v2.1.215 (current binary v2.1.215 = npm `latest` = `next` = 215; `stable` = v2.1.205). System prompt paraphrased from v2.1.98 (verbatim text withheld) and confirmed byte-identical through v2.1.215. Advisor confirmed code-complete in v2.1.96 (coexisting with full buddy system — both scored FULL). Feature-gate status: advisor gate still not rolled out to this account as of session 80. buddy_react API confirmed alive (200 OK, 1331ms latency) at original investigation. Companion config intact in `~/.claude/.claude.json`.*
