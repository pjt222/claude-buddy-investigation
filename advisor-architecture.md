...
**Date**: 2026-04-10 · **Last revised**: 2026-07-22 (session 81, v2.1.217 currency pass)
**Version**: 1.8
...
v2.1.216 -> v2.1.217   Session 81. Advisor core surface BYTE-STABLE
                        ...
                        finding is advisor-related: #168 (HIGH, v216) is a
...
*Investigation conducted 2026-04-10; revised 2026-07-22 (session 81). Binary analysis on v2.1.96, v2.1.97, v2.1.98, v2.1.100; currency re-verified against v2.1.217 (current binary v2.1.217 = npm `latest` = `next` = 217; `stable` = v2.1.206). System prompt paraphrased from v2.1.98 (verbatim text withheld) and confirmed byte-identical through v2.1.217. Advisor confirmed code-complete in v2.1.96 (coexisting with full buddy system — both scored FULL). Feature-gate status: advisor gate still not rolled out to this account as of session 81. buddy_react API confirmed alive (200 OK, 1331ms latency) at original investigation. Companion config intact in `~/.claude/.claude.json`.*
