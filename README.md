...
- `SECURITY-AUDIT.md` — original 14-finding security audit across CLI, MCP server, capture system, and docs site. The live tally has since grown well beyond this with post-audit harness-level findings: `docs/counts.js` tracks an audit-baseline lineage and a live-GH re-derivation (2026-05-27) of **12 critical / 31 high / 46 medium / 8 low = 97 severity-labeled across 136 repo issues**. `docs/counts.js` is the single source of truth — see its two-axis tally.
