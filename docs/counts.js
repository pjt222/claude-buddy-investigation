...
window.VIZ_COUNTS = Object.freeze({
  ...
  security: {
    ...
    gh_label_counts: {
      ...
      labeled_total: 128,   // 14C + 39H + 60M + 15L
      unlabeled_by_severity: 40,
      repo_total: 168,  // session-81: +2 total = #168 (HIGH) and #169 (LOW), BOTH genuine harness findings - the first non-zero-finding window since v208. PRIOR session-80: +2 total = #166 (prompt-variant watch tracker) and #167 (a tooling/process issue recording a redaction-enforcer gap in this project OWN publish pipeline, found and fixed the same session). Harness findings this window: ZERO.
