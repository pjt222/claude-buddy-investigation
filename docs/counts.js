...
window.VIZ_COUNTS = Object.freeze({
  ...
  version: {
    ...
    range: "v2.1.89 \u2192 v2.1.217",  // unicode rightwards arrow. hero badge reads version.range; session-81 audited through v217 (npm latest=next), stable advanced v205 to v206
